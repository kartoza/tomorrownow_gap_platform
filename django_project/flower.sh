...
FLOWERCTL="-A core --broker=redis://default:$REDIS_PASSWORD@$REDIS_HOST flower --port=9090 --url_prefix=/flower --auto_refresh=False --broker_api=redis://default:$REDIS_PASSWORD@$REDIS_HOST"
DAEMON=$FLOWERCTL
