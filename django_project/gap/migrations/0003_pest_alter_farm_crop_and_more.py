# Generated by Django 4.2.7 on 2024-08-08 05:03
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('attribute', models.ForeignKey(help_text='Forecast attribute', on_delete=django.db.models.deletion.CASCADE, to='gap.attribute')),
                ('farm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='gap.farm')),
            ],
            options={
        ...
        migrations.CreateModel(
            name='FarmProbabilisticWeatherForcastTable',
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('forecast_date', models.DateField(default=django.utils.timezone.now, help_text='Date when the forecast is made')),
